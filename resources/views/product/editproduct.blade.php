        ...
        <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <textarea name="description" id="description" class="form-control form-text {{ $errors->has('description') ? "is-invalid" : "" }}" placeholder="Introduce tu descripción" rows="3">{{ $product->description }}</textarea>
            ...
            <div class="row">
                <div class="col-3">
                    ...
                    <select name="status" id="status" class="form-control form-select">
                        <option value="1" {{ $product->status ? "selected" : "" }}>En stock</option>
                        <option value="0" {{ !$product->status ? "selected" : "" }}>No disponible</option>
                    </select>
                </div>
                <div class="col-9">
